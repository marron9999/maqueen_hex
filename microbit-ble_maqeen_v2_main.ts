...
let V_Button = { A: 0, B: 0, L:0, P0:0, P1:0, P2:0 }
let V_LightLevel = 0
let V_Temperature = 0
...
function stop_maqueen() {
    if(R_Connect > 0) {
        ...
        basic.showLeds(`. . . . #
                        ...
                        . # . . .
                        . . . . .`)
        play_tone(131, music.beat(BeatFraction.Sixteenth))
        R_Connect = 0
    }
}
...
function play_tone(v : number, w : number) {
    music.playTone(v, w)
}
...
function parse_request() {
    ...
    if (c == "B") {
        play_tone(523, music.beat(BeatFraction.Sixteenth))
...
basic.forever(function () {
    ...
    if ((R_Microbit & 16) != 0) {
        ...
        if (V_Gesture != v) {
            V_Gesture = v
            bluetooth.uartWriteString("G-" + V_Gesture)
        }
    }
